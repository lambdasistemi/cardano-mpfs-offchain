...
data Context m = Context
    ...
    -- primitives from "Cardano.MPFS.Indexer.Reads"
    -- (e.g. @readSnapshot@, @readWalletInputsAt@) and
    -- discharge the composition through this field;
    -- the atomicity of all reads contained in the
